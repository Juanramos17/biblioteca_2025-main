...
return [
    ...
    'bookshelves' => [
        'created' => 'Estante creado correctamente',
        'updated' => 'Estante actualizado correctamente',
        'deleted' => 'Estante eliminado correctamente',
        'error' => [
            'create' => 'Error al crear el estante',
            'update' => 'Error al actualizar el estante',
            'delete' => 'Error al eliminar el estante',
        ],
    ],
    'zones' => [
