...
export default function EditLoan({ initialData, page, perPage, lang, emails }: LoanProps) {
        ...
        <LoanLayout title={t('ui.loans.create')}>
            <div className="flex w-full flex-col items-center px-4">
                <div className="bg-muted/50 flex w-full max-w-3xl flex-col rounded-lg shadow-md">
                    ...
                    <div className="grid grid-cols-1 gap-4 pr-4 pl-4 md:grid-cols-2">
                        <LoanForm initialData={initialData} page={page} perPage={perPage} lang={lang} emails={emails} />
                    </div>
                </div>
            </div>
        </LoanLayout>
